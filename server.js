...
app.use("/users", express.static('./views/users.html'))
app.use("/animals", express.static('./views/animals.html'))
app.use("/service-type", express.static('./views/service-type.html'))
